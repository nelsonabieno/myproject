...
<html lang="en">
	...
	<head>
		...
		<!-- end: MAIN CSS -->
		<!-- start: CLIP-TWO CSS -->
		<link rel="stylesheet" href="../../../assets/admin/admin_resource/css/styles.css">
		<link rel="stylesheet" href="../../../assets/admin/admin_resource/css/plugins.css">
		<link rel="stylesheet" href="../../../assets/admin/admin_resource/css/themes/theme-1.css" id="skin_color" />
		<!-- end: CLIP-TWO CSS -->
	...
	<body class="login">
		...
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				<div class="logo margin-top-30">
					<img src="../../../assets/admin/admin_resource/images/logo.png" alt="Clip-Two"/>
				</div>
				<!-- start: FORGOT BOX -->
					...
					<form class="form-forgot">
						<fieldset>
							...
							<div class="form-actions">
								<a class="btn btn-primary btn-o" href="login_signin.php">
		...
		<script src="../../../assets/admin/admin_resource/js/main.js"></script>
		<!-- start: JavaScript Event Handlers for this page -->
		<script src="../../../assets/admin/admin_resource/js/login.js"></script>
		<script>
