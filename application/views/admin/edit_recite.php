    ...
    <div class="main-content" >
        <div class="wrap-content container" id="container">
            ...
            <div class="container-fluid container-fullw bg-white">
                <h1><strong><p class="success"> EDIT RECITATION</p></strong></h1>
                <a id='add' href='#'class='fa fa-pencil'> </a>Edit Recitation
                <div class="row">
                    ...
                    <div class="panel panel-white no-radius text-center">
                        <div class="panel-body">
                            <form id="myform" action="<?php echo base_url('users/adminReciteEdit'); ?>" method="post">
                                <div class="table-responsive">

                                    <table class="table">

                                        <?php foreach ($specificRecite as $obj)
                                        {


                                            echo "<tr><td ><strong>#</strong> </td> <td colspan=2><input type='text' name='id' id='id' value='".$obj->id."' required readonly/></td></tr>";
                                            echo "<tr><td ><strong>RECITATION</strong> </td> <td colspan=2><input type='text' name='recite' id='recite' value='".$obj->recite."' required/></td></tr>";


                                            echo "<tr><td ><strong>APPROVE</strong> </td> <td colspan=2><input type='text' name='approve' id='date_added' value='".$obj->approve."' required/></td></tr>";
                                            echo "<tr><td ><strong>EDIT</strong> </td> <td colspan=2><input type='text' name='edit'  id='username' value='".$obj->edit."' required/></td></tr>";
                                            echo "<tr><td ><strong>BANN</strong> </td> <td colspan=2><input type='text' name='ban'  id='password' value='".$obj->ban."' required/></td></tr>";
                                            echo "<tr><td ><strong>DELETE</strong> </td> <td colspan=2><input type='text' name='delet'  id='status' value='".$obj->delet."' required/></td></tr>";
