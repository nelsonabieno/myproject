    ...
    <div class="main-content">
        <div class="wrap-content container" id="container">
            ...
            <div class="container-fluid container-fullw bg-white">
                <h1><strong><p class="success"> ADMIN</p></strong></h1>
                <a id='add' href='#' class='fa fa-user-plus'></a>Admin
                <div class="row">
                    <?php
                    if ($this->session->flashdata('admin_success')) {
                        echo " <h1><p class='text-success text-center'>" . $this->session->flashdata('admin_success') . "</p></h1>";


                    }
                    if ($this->session->flashdata('admin_failed')) {
                        echo " <h1><font color='red'><p class='text-center'>" . $this->session->flashdata('admin_failed') . "</p></font></h1>";
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table">
                                        <tr>
                                            ...
                                            <td colspan="2"><strong>FULLNAME</strong></td>
                                            <td colspan="2"><strong>EMAIL</strong></td>
                                            <td colspan="2"><strong>PHONE NUMBER</strong></td>
                                            <td colspan="2"><strong>STATUS</strong></td>
                                            <td colspan="2"><strong>Approve</strong></td>
                                            <td colspan="2"><strong>Edit</strong></td>
                                            <td colspan="2"><strong>Ban</strong></td>
                                            <td colspan="2"><strong>Delete</strong></td>
                                        </tr>


                                        <?php foreach ($allAdmin as $obj) {
                                            echo "<tr>";
                                            ...
                                            echo "<td colspan=2>" . $obj->phone . "</td>";
                                            ...
                                            echo "<td colspan=2><a  onclick='' href='getSpecificAdminRecord?id=$obj->id' class='fa fa-pencil'>Edit</a></td>";
                                            echo "<td colspan=2><a id='edit' href='getSpecificAdminRecord?id=$obj->id;'class='fa fa-thumbs-up'>Approve</a></td>";
                                            echo "<td colspan=2><a id='ban' href='getSpecificAdminRecord?id=$obj->id;'class='fa fa-ban'>Ban</a></td>";
                                            echo "<td colspan=2><a id='delete' href='getSpecificAdminRecord?id=$obj->id;'class='fa fa-remove'>Delete</a></td>";
                                  ...
                                  //  alert('id = '+$obj->id);
                                    ...
                                    alert('inside getID fn '+id.substring(10,13));
                                        ...
                                        echo "<td colspan=2><a id='add' href='#'class='fa fa-user-plus'  data-toggle='modal' data-target='.bs-example-modal-sm'>Add Admin</a></td>";
                ...
                <div class="modal-dialog modal-sm">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div id="insertDiv">
                                <form id="idForm" action="adminRegisterAdmin" method="post">
                                    ...
                                    <table class="table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="id" name="id"
                                                       value="<?php echo rand(2000, 3000); ?>" readonly/></td>
                                        </tr>
                                        <tr>
                                            <td> FULL NAME</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="password" id="password" name="password2" value=""/></td>
                                        </tr>
                ...
                <div class="footer-inner">
                    <div class="pull-left">
                        &copy; <span class="current-year"></span><span
                            class="text-bold text-uppercase"> Qurancom 2016</span>. <span>All rights reserved</span>
                    </div>
